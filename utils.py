...
def parse_stat_trait(trait):
    ...
    stats['parsedClass'] = parse_class(stats['class'])
    stats['parsedSubClass'] = parse_class(stats['subClass'])
    stats['parsedProfession'] = parse_profession(stats['profession'])
    stats['blueStat'] = stats['statBoost1']
    stats['greenStat'] = stats['statBoost2']

    return stats

def parse_extra(genes):
  traits = genes2traits(genes)
  st = parse_stat_trait(traits[0])
  stats = {}
  stats['parsed_class'] = st['parsedClass']
  stats['parsed_subclass'] = st['parsedSubClass']
  stats['parsed_profession'] = st['parsedProfession']
  stats['green_stat'] = st['greenStat']
  stats['blue_stat'] = st['blueStat']
  stats['profession'] = st['profession']
  return stats
